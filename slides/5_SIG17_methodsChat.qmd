...
format: 
  revealjs:
      ...
      footer: "Slides: [t1p.de/sig17-repro26](https://t1p.de/sig17-repro26)"
      smaller: true
      scrollable: true
      transition: fade
      width: 1500
...
## Questions! {.section-title .dark-slide}
Please go to **pollev.com/js123**
...
> "In principle, all reported evidence should be reproducible" [@nosek.2022, p. 721]
...
**@artner.2021**: **232** scientific claims from **46** journal articles
\
...
[![](www/renv_logo.png){width="60%"}](https://rstudio.github.io/renv/articles/renv.html)
:::
...
:::: {.columns}
:::{.column width = "20%" .text-center .border-top1}
[![](www/groundhog_logo.png){width="60%"}](https://groundhogr.com/)
:::
:::{.column width = "25%" .text-center .border-top1}
`r fa("circle-check", fill = "#79B530", height = "80px", prefer_type = "solid")`  
:::
...
:::: {.columns}
:::{.column width = "20%" .text-center .border-top1}
[![](www/holepunch_logo.png){width="60%"}](https://karthik.github.io/holepunch/)  
:::
:::{.column width = "25%" .text-center .border-top1}
:::
:::{.column width = "25%" .text-center .border-top1}
...
**Principle:** "As open as possible, as closed as necessary" [@europeancommission.2018a]
:::
::::
