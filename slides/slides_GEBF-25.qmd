...
:::{focus-on="cr-versionen5"}
![](www/holepunch_logo.png)

# Softwareumgebung durch "Container"
:::


:::{#cr-versionen5}

**Holepunch** stellt passende Softwareumgebung her (z. B. R-Version):  
(benötigt GitHub)
...
write_runtime() # Writes the date your code was last modified.
...
:::{focus-on="cr-versionen6"}
# Beispiel
## Klick auf Button in [diesem Repo](https://github.com/j-5chneider/subcommunitiesOS) führt zu...
:::


:::{#cr-versionen6}
![](www/binder_browser.jpg){.fig-story95}
:::
...
:::
:::{.column .thirdcol .addborder}
![](www/renv_logo.png){width=20%}  
Versionskontrolle via renv
:::
:::{.column .fourthcol .addborder}
